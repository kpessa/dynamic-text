...
if (neonatalData && neonatalData.INGREDIENT) {
  neonatalData.INGREDIENT.forEach(ingredient => {
    if (ingredient.KEYNAME) {
      ingredientMap.set(ingredient.KEYNAME, ingredient);
    }
  });
}
 ...
 */
export function getIngredientConfig(keyname) {
 ...
 */
export function getAllIngredientConfigs() {
 ...
 */
export function hasReferenceRanges(keyname) {
 ...
 */
export function getIngredientNotes(keyname) {
  const config = getIngredientConfig(keyname);
 ...
 */
export function processDynamicNote(noteText, meObject) {
 ...
 */
export function getIngredientDisplay(keyname) {
  const config = getIngredientConfig(keyname);
  return {
