...
// Removed unused imports - onSnapshot and db are not used in this file
...
export class FirebaseService {
  ...
  getMetrics(): ServiceMetrics {
    ...
    return {
      ...
      network: {
        isOnline: networkState.isOnline,
        ...(networkState.connectionType && { connectionType: networkState.connectionType }),
        ...(networkState.effectiveType && { effectiveType: networkState.effectiveType })
      }
    };
  }
